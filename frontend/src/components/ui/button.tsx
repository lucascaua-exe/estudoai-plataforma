...
const buttonVariants = cva(
  [
    ...
    'cursor-pointer transition-[background-color,border-color,color,box-shadow,opacity,transform] duration-[150ms] ease-[cubic-bezier(0.22,1,0.36,1)]',
  ...
  ].join(' '),
  {
    variants: {
      ...
      size: {
        ...
        sm: 'h-11 min-h-11 rounded-lg px-3 text-sm',
